...
|          | - Потратив еще пару часов на поиск решения методом проб и ошибок, я, возможно, нашел причину.. _**(XL - говно, запомните это, без шуток это правда)**_. А пока воспользуйтесь `БЕТА-версией` моего colab, возможно, она все еще будет работать. |
